package com.maiko.maikoaicodemother.generator;
...
public class MyBatisCodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        dataSource.setJdbcUrl(url);        // 方式一：格式化输出 dataSourceConfig
...
//        dataSourceConfig.forEach((key, value) -> System.out.println(key + " = " + value));
    ...
    public static GlobalConfig createGlobalConfig() {
        ...
        globalConfig.getPackageConfig()
                .setBasePackage("com.maiko.maikoaicodemother.genresult");
...
//                .setAuthor("<a href=\"https://i.csdn.net/#/user-center/profile?spm=1000.2115.3001.5111\">Maiko7</a>")
                .setAuthor("代码卡壳Maiko7")
                .setSince("");
        return globalConfig;
    }
}
