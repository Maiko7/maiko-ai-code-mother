...
import com.maiko.maikoaicodeuser.constant.AppConstant;
 ...
 * 文件目录读取工具
 * <p>
 * 使用 Hutool 简化文件操作，用于读取并展示指定目录下的文件树结构。
 * 包含对 node_modules、.git 等无关目录的过滤逻辑。
 */
@Slf4j
@Component
        ...
        try {
            ...
            allFiles.stream()
                    ...
                    .forEach(file -> {
                        ...
                        String indent = "  ".repeat(depth); // 使用空格进行缩进
